...
hl.bind(mod .. " + W", hl.dsp.exec_cmd("ryoku-shell menu wallpaper"))
...
hl.bind(mod .. " + V", hl.dsp.global("ryoku:clipboard"))
hl.bind(mod .. " + Tab", hl.dsp.global("ryoku:overview"))
hl.bind(mod .. " + M", hl.dsp.global("ryoku:visualizer"))
hl.bind(mod .. " + F", hl.dsp.window.fullscreen())
hl.bind(mod .. " + L", hl.dsp.exec_cmd("ryoku-shell lock"))
hl.bind(mod .. " + N", hl.dsp.global("ryoku:quicksettings"))
hl.bind(mod .. " + SHIFT + S", hl.dsp.exec_cmd("flock -n -o /tmp/ryoshot.lock qs -p /usr/share/ryoku-source/ryoku/shell/quickshell/ryoshot"))
hl.bind("Print", hl.dsp.exec_cmd("flock -n -o /tmp/ryoshot.lock qs -p /usr/share/ryoku-source/ryoku/shell/quickshell/ryoshot"))
hl.bind("SHIFT + Print", hl.dsp.exec_cmd("flock -n -o /tmp/ryoshot.lock env RYOSHOT_MODE=monitor qs -p /usr/share/ryoku-source/ryoku/shell/quickshell/ryoshot"))
...
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("ryoku-volume up"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("ryoku-volume down"), { locked = true, repeating = true })
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("ryoku-volume mute"), { locked = true })
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"), { locked = true })
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("ryoku-shell brightness up"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("ryoku-shell brightness down"), { locked = true, repeating = true })
