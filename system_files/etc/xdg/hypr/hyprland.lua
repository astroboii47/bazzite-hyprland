...
hl.bind(mod .. " + W", hl.dsp.exec_cmd("bazzite-ryoku-wallpaper"))
hl.bind(mod .. " + comma", hl.dsp.exec_cmd("bazzite-ryoku-theme"))
hl.bind(mod .. " + Escape", hl.dsp.global("bazzite-ryoku:quicksettings"))
hl.bind(mod .. " + S", hl.dsp.global("bazzite-ryoku:quicksettings"))
