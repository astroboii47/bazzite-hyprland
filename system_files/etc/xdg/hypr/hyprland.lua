...
hl.on("hyprland.start", function()
    hl.exec_cmd("pkill -f 'quickshell.*bazzite-ryoku' 2>/dev/null || true; bazzite-ryoku-first-login; dbus-update-activation-environment --systemd --all; systemctl --user daemon-reload; systemctl --user reset-failed ryoku-shell.service ryogami.service 2>/dev/null; systemctl --user restart ryoku-shell.service ryogami.service")
...
hl.bind(mod .. " + R", function()
    ...
    hl.dispatch(hl.dsp.exec_cmd("hyprctl notify -1 2200 0 'Resize mode: arrows or H/J/K/L resize; Escape exits'"))
end)
